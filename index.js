//
// Alphactyl v-1.0, Codename Kyiv
// 
//  * Copyright ALPHA IN 2022
...
const listener = app.listen(settings.website.port, function() {
  console.log(chalk.red("――――――――――――――――Welcome to Alphactyl――――――――――――――――――――――――――――――――"));
  console.log(chalk.red("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――"));
  console.log(chalk.green("Alphactyl V1 is now online at port " + listener.address().port + " "));
  console.log(chalk.red("――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――"));
});
